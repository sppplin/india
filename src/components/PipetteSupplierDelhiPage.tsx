...
import { Phone, CheckCircle2, ArrowRight, ArrowLeft, Send, Sparkles, AlertCircle, Award } from 'lucide-react';
import { ActiveView } from '../types';

interface PipetteSupplierDelhiPageProps {
  onNavigateToPage: (view: ActiveView) => void;
  onContactClick: () => void;
}

export default function PipetteSupplierDelhiPage({ onNavigateToPage, onContactClick }: PipetteSupplierDelhiPageProps) {
  // Local form state
  const [formData, setFormData] = useState({
    ...
    email: '',
    institution: '',
    specifications: 'Glass Pipettes (Volumetric & Graduated) with Disposable Tips - Delhi Region',
    quantity: '500 pcs',
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSubmitting(false);
      setSubmitted(true);
      console.log('Delhi Pipette Inquiry Submitted:', formData);
    }, 850);
  };
      ...
      <div className="max-w-[960px] mx-auto space-y-8 bg-white border border-gray-200 rounded-2xl shadow-sm p-5 md:p-8">
        ...
        <div className="border-b border-gray-150 pb-5 space-y-2">
          ...
          <h1 className="font-heading font-black text-2xl md:text-3.5xl text-gray-900 leading-tight">
            Pipette Supplier in Delhi — Volumetric, Graduated & Tips
          </h1>
          <p className="text-[#FC913A] font-extrabold text-xs tracking-widest uppercase font-mono">
            Direct Manufacturing & Daily NCR Deliveries Since 1993
          </p>
        </div>
        ...
        <div className="prose max-w-none text-slate-800 text-sm md:text-base leading-relaxed font-sans font-light">
          <p>
            <strong>Yukon India Corporation</strong> is a pipette supplier in Delhi, serving universities, diagnostic laboratories, and pharmaceutical companies from our manufacturing facility in neighbouring Ghaziabad, NCR. With three decades of experience supplying Delhi's research and healthcare sector, we provide both precision glassware pipettes and disposable plasticware tips under one supply relationship.
          </p>
        </div>
        ...
        <div className="bg-slate-50 border-2 border-emerald-800 p-5 md:p-6 rounded-xl shadow-md space-y-4">
          <div className="pb-3 border-b border-gray-200">
            ...
            <h3 className="font-heading font-bold text-gray-900 text-sm md:text-base mt-1 uppercase">
              Download Specifications & Get Bulk Pipette Pricing
            </h3>
          ...
          {submitted ? (
            <div className="bg-emerald-50 border border-emerald-250 p-6 rounded-lg text-center space-y-3">
              ...
              <p className="text-[11.5px] text-gray-600 max-w-sm mx-auto leading-relaxed">
                Thank you! Our regional technical dispatch coordinators are matching your specifications. An official wholesale quotation will be delivered to <strong>{formData.phone}</strong> shortly.
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div>
                ...
                <input
                  type="tel"
                  required
                  placeholder="e.g. +91 93123 45678"
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. AIIMS Delhi / Ranbaxy R&D"
              ...
              <div>
                <label className="block text-gray-700 font-bold uppercase tracking-wider mb-1 text-[10px]">
                  Required Quantity / Volume Ranges <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  required
                  placeholder="e.g. 100 pcs 10ml Volumetric, 500 boxes Tips"
              ...
              <div className="sm:col-span-2">
                <label className="block text-gray-700 font-bold uppercase tracking-wider mb-1 text-[10px]">
                  Technical Pipette Specifications (Class A/B, Graduations, Materials)
                </label>
                <textarea
                  rows={2}
                  placeholder="ISO 1769 standards, Color-coded, safety bulb, specific tip configurations, etc."
              ...
              <div className="sm:col-span-2 bg-white border border-gray-150 p-2.5 rounded text-[10.5px] text-gray-500 flex items-start gap-2">
                ...
                <span>
                  All custom-calibrated pipettes undergo high-fidelity verification and carry individual or batch certification tracing credentials.
                </span>
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                >
                  ...
                  <span>{submitting ? 'Transmitting Delhi Pricing Catalog...' : 'Get Delhi Pipette Quote'}</span>
                </button>
              </div>
            </form>
          )}
        ...
        <div className="space-y-6 pt-4 font-sans border-t border-gray-100">
          ...
          <div className="space-y-3">
            <h2 className="font-heading font-black text-lg md:text-xl text-gray-950 uppercase tracking-tight flex items-center gap-2 border-b border-gray-100 pb-2">
              ...
              Why Delhi Institutions Choose This Pipette Supplier
            </h2>
            <div className="text-gray-700 text-xs md:text-sm leading-relaxed space-y-3 font-light">
              <p>
                Delhi's diagnostic chains, hospital labs, and university chemistry departments need a pipette supplier in Delhi who can guarantee consistent calibration accuracy across large order volumes. Our pipettes are manufactured under ISO 9001 certified processes, and our NCR location means Delhi buyers receive orders without multi-day transit delays.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3 bg-slate-50 border border-slate-100 p-5 rounded-xl">
            <h2 className="font-heading font-black text-xs md:text-sm text-gray-950 uppercase tracking-widest flex items-center gap-2 mb-2">
              ...
              Pipette Types We Supply
            </h2>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-700">
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Volumetric (bulb) pipettes for single-volume precision measurement</span>
              </li>
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Graduated (Mohr and serological) pipettes for variable volume dispensing</span>
              </li>
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Pasteur pipettes for general liquid handling</span>
              </li>
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Disposable plastic pipette tips for micropipettes, multiple volume ranges</span>
              </li>
            </ul>
          </div>

          {/* Segment 3: Who We Supply in Delhi */}
          <div className="space-y-3">
            <h2 className="font-heading font-black text-lg md:text-xl text-gray-950 uppercase tracking-tight flex items-center gap-2 border-b border-gray-100 pb-2">
              <span className="w-1.5 h-5 bg-[#1E4D2B] rounded-full inline-block shrink-0"></span>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-700">
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Diagnostic and pathology lab chains across Delhi NCR</span>
              </li>
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>University and college chemistry/biology departments</span>
              </li>
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Pharmaceutical QC and R&D departments</span>
              </li>
              <li className="flex items-center gap-2 bg-white px-3 py-2 rounded border border-gray-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
                <span>Hospital-based clinical laboratories</span>
              </li>
            </ul>
          </div>

          {/* Segment 4: Delivery to Delhi */}
          <div className="space-y-3">
            <h2 className="font-heading font-black text-lg md:text-xl text-gray-950 uppercase tracking-tight flex items-center gap-2 border-b border-gray-100 pb-2">
              <span className="w-1.5 h-5 bg-[#1E4D2B] rounded-full inline-block shrink-0"></span>
            ...
            <p className="text-gray-700 text-xs md:text-sm leading-relaxed font-light">
              As your local pipette supplier in Delhi, most orders are dispatched within 24-48 hours given our NCR proximity. This supports rapid procurement of critical laboratory supplies without holding excess stock.
            </p>
          </div>
          ...
          <div className="bg-emerald-950 text-white rounded-xl p-5 md:p-6 space-y-4">
            <div className="space-y-1">
              ...
              <h2 className="font-heading font-black text-sm md:text-base uppercase tracking-wider text-white">Get Your Pipette Quote</h2>
              <p className="text-xs text-gray-300 font-light">
                Call +91 84475 12326 or email yukonindia45@gmail.com with your pipette requirements and calibration tolerances.
              </p>
            </div>
          ...
          <div className="space-y-3 pt-4 border-t border-gray-150">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
              ...
              >
                <span>View Full Laboratory Catalog →</span>
              ...
              <button
                ...
                className="flex items-center justify-between text-left px-3.5 py-3 text-xs font-semibold rounded bg-slate-100 hover:bg-[#1E4D2B]/5 border border-slate-200 hover:border-[#1E4D2B] text-gray-850 hover:text-[#1E4D2B] transition-all group cursor-pointer"
              >
                <span>Pan-India Pipette Supplies (MOQ 500)</span>
                <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-[#1E4D2B] transform group-hover:translate-x-0.5 transition-transform" />
              </button>
            </div>
          </div>
